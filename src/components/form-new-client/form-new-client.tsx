...
const AddClientForm:React.FC = () => {
    ...
    const createCustomer = (data: any) => {
        const variables = {
            ...
            //todo for upload file to db
            //avatarUrl: (data.clienPhoto) ? data.clienPhoto[0].name : defoultAvatar
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} className={'client__form'}>
                ...
                {/* todo - File input for upload file to db - */}
                {/*<div className="client__form--group mb-12">*/}
                {/*    <label htmlFor={'clienPhoto'} className={'client__form--label'}>*/}
                {/*        Upload photo*/}
                {/*    </label>*/}
                {/*    <div className="file-field input-field client__form--photo">*/}
                {/*        <div className="btn bg-blue-500">*/}
                {/*            <span>File</span>*/}
                {/*            <input type="file" name={'clienPhoto'} ref={register} />*/}
                {/*        </div>*/}
